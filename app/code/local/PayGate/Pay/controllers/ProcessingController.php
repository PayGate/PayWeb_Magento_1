	...
	public function notifyAction(){
		...
		if(!$errors){
			...
			if($status == 0 || $status == 4){
				$order->setState(Mage_Sales_Model_Order::STATE_CANCELED, 'Canceled', 'Cancelled Payment with PayGate', true);
				...
				$order->setState(Mage_Sales_Model_Order::STATE_CANCELED, 'Canceled', 'Failed to make Payment with PayGate due to transaction declined', true);
